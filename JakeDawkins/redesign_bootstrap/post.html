...
<head>
    ...
    <meta name="description" content="Jake Dawkins's. Developer: web, iOS.">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                    ...
                    <p>This app interfaces with a MySQL database to read and write data about multiple sensors and control systems in the house. For a more detailed look at how this works, see the <a href="#">Technical Reference Manual</a>.</p>
                    
                    <p>For more information...</p>

                    <ul>
                        <li>
                            <a href="projects/sdhome/2.SD.Home.Control-App.zip">Final App Code</a>
                        </li>
                        <li>
                            <a href="projects/sdhome/SmartHomeSimulator.zip">Final Smart Home Simulator</a>
                        </li>
                        <li>
                            <a href="projects/sdhome/2.SD.Home.Control.P6.UserManual.pdf">Final User Manual</a>
                        </li>
                        <li>
                            <a href="projects/sdhome/2.SD.Home.Control.P2B.pdf">Full Product Proposal</a>
                        </li>
                        <li>
