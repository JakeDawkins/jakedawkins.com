        ...
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                ...
                <div class="post-preview">
                    <a href="projects/thrownote-p4.php">
                        ...
                        <h3 class="post-subtitle">
                            ...
                            &nbsp;&nbsp;
                            P5 Submission for CPSC 4820
                        </h3>
                    </a>
                    <p class="post-meta">Posted by Jake on April 18, 2016</p>
                </div>
                <hr>
                ...
                <div class="post-preview">
                    <a href="projects/thrownote-p4.php">
                        <h2 class="post-title">
                            ThrowNote Updates (P4)
                        </h2>
                        <h3 class="post-subtitle">
                            <span class="glyphicon glyphicon-book color-orange" data-toggle="tooltip" title="Completed For School" data-placement="left"></span>
                            &nbsp;&nbsp;
                            P4 Submission for CPSC 4820
                        </h3>
                    </a>
                    <p class="post-meta">Posted by Jake on April 11, 2016</p>
                </div>
                <hr>

                <!-- P3 -->
                <div class="post-preview">
                    <a href="projects/thrownote-p3.php">
                        <h2 class="post-title">
                            ThrowNote Updates (P3)
                        </h2>
                        <h3 class="post-subtitle">
                            <span class="glyphicon glyphicon-book color-orange" data-toggle="tooltip" title="Completed For School" data-placement="left"></span>
                            &nbsp;&nbsp;
                            P3 Submission for CPSC 4820
                        </h3>
                    </a>
                    <p class="post-meta">Posted by Jake on April 4, 2016</p>
                </div>
                <hr>
